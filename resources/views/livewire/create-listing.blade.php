<div class="max-w-2xl mx-auto p-4 sm:p-6 lg:p-8 bg-white dark:bg-gray-800 shadow-md dark:shadow-gray-900/50 rounded-lg mt-10 transition-colors duration-300">
    ...
    <form wire:submit.prevent="save" class="space-y-6">
        ...
        <div class="border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-lg p-6 text-center hover:border-indigo-500 dark:hover:border-indigo-400 transition">
            ...
            <label for="photo-upload" class="cursor-pointer">
                <div class="text-gray-500 dark:text-gray-400">
                    ...
                    <p class="text-xs text-gray-400 dark:text-gray-500">Up to 3 photos allowed</p>
                </div>
            </label>
        ...
        <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300">ምድብ (Category)</label>
            <select wire:model="category" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 shadow-sm p-3 bg-gray-50 dark:bg-gray-700 dark:text-gray-100">
